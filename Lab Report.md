...
Manual functional testing is preffered as it is repeatable, heavily planned, and easier to document. However, Exploratory testing allowed us to find defects that would have not been discovered with MFT alone.
